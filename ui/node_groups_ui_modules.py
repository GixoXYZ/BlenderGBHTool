...
def _node_outputs(layout, sub_panel, ng):
    valid_node_outputs_names = [
...
def ng_stack(context, layout, mod):
    ...
    if sub_panel[0]:
        ...
        if mod.type == "NODES":
            _node_inputs(body, mod)
            _node_outputs(body, sub_panel, mod)
